...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        let cors = Cors::default()
            .allowed_origin("https://dev-binarybrains-frontend-1d4adc9033e4.herokuapp.com")
        ...
        App::new()
            ...
            .configure(init_routes)  // Initialize your routes in a separate function for clarity
    })
